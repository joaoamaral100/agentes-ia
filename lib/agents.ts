...
3. AÇÃO:
— UNBOXING: "Two elegant feminine hands with firm, realistic physical contact, opening the flaps of the cardboard box, revealing [PRODUTO] resting inside, nestled in protective packaging (foam/paper), still nested in the box — not lifted out, not held up, not removed from the box. Fingers gently touch the box edges and packaging material, conveying the moment of freshly receiving the delivery. The product has clear physical support (resting inside the box) — never floating."
...
CENA [N] — POV
Ultra-realistic 8K vertical 9:16 POV TikTok video. Bird's-eye top-down angle looking straight down at [PRODUTO] centered on a clean minimal surface. NO face shown at any point — NO person visible, only hands. PRODUCT REMAINS COMPLETELY SEALED/CLOSED THROUGHOUT — never opened, never unscrewed, never opened, never revealing internal contents. Two elegant feminine hands enter from frame edges: fingers touch and gently rotate the sealed product to showcase EXTERNAL packaging features (label, design, cap/lid, dimensions, branding, material texture) — hands ONLY interact with the OUTER SURFACE and sealed exterior, never attempting to open or access the interior. Hands hover and move naturally, never grabbing or blocking the product. Focus is exclusively on package design and external features, never on opening, consuming, or using the product internally. Product is the absolute protagonist filling center of frame. Clean neutral background, soft diffused top-down lighting, shallow depth of field highlighting packaging texture and label details. Female voice speaks naturally in Brazilian Portuguese, conversational tone — voice only, no body shown. No subtitles, no on-screen text, no app interfaces, no added music, 8K ultra-photorealistic.
